...
![antani_concept](f_ops/concept_antani.svg "antani concept")
_antani concept_

Each ant can, sense, move, act and based on the reward the best current solution is taken. 

![concet_antani](f_ops/antani_concept.svg  "concept antani")
...
![markov_chain](f_ops/markov_3.png "Markov chain")
_Markov chains_
...
![post_prob](f_ops/post_prob.svg "posterior probabilities")
...
![concept_mallink](f_ops/concept_mallink.svg "concept mallink")
...
![engine](f_ops/vid_phantom.gif "engine")
...
![reinforce_move](f_ops/reinforce_move.svg "reinforce move")
...
![kpi](f_ops/kpi_comparison.png "kpi comparison")
...
![antani_infra](f_ops/antani_infra.svg "antani_infra")

#+SPDX-FileCopyrightText: 2017-2025 sabeiro <https://intertino.it>
...
#+REVEAL_PREAMBLE: <div class="legalese"><p><a href="spiega.html">home </a> | <a href="../a/imprint.html"> imprint </a> | <a href="../a/privacy.html"> privacy </a></p></div>
# -*- eval: (visual-line-mode) -*-
# SPDX-FileCopyrightText: 2017-2025 sabeiro
# SPDX-License-Identifier: CC-BY-SA-4.0
...
#+REVEAL_TRANS: fade
#+REVEAL_THEME: league3
#+REVEAL_PLUGINS: (notes search highlight chalkboad)
# The following variables are non-standard.
# Use different heading for TOC.
#+REVEAL_TOC_SLIDE_TITLE: Agenda
#+REVEAL_EXTRA_CSS: ../reveal/css/reveal_custom.css
# Allow to selectively hide links.
#+REVEAL_EXTRA_SCRIPTS: ("../reveal/js/reveal_custom.js")
#+REVEAL_EXTRA_SCRIPTS: ("../reveal/js/highlight.js")
# Set a default bib file.
#+REVEAL_ADD_PLUGIN: chalkboard RevealChalkboard
...
#+MACRO: bibliographyfile bibliography:bibliography.bib
...
#+LATEX_HEADER: \setitemize{leftmargin=*}
#+LATEX_HEADER: \setenumerate{leftmargin=*}
#+LATEX_HEADER: \renewcommand\labelitemii{\raisebox{0.25ex}{\small$\bullet$}}
#+LATEX_HEADER: \renewcommand\labelitemiii{\raisebox{0.25ex}{\footnotesize$\bullet$}}
#+LATEX_HEADER: \renewcommand\labelitemiv{\raisebox{0.25ex}{\tiny$\bullet$}}
#+LATEX_HEADER: \usepackage[backend=biber,style=alphabetic]{biblatex}
#+LATEX_HEADER: \addbibresource{references.bib}
#+LATEX_HEADER: \newenvironment{notes}{\par\footnotesize}{\par}
#+LATEX_HEADER: \newenvironment{NOTES}{\par\footnotesize}{\par}
#+LATEX_HEADER: \newenvironment{leftcol}{\begin{minipage}[t]{.49\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{rightcol}{\begin{minipage}[t]{.49\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{leftcol30}{\begin{minipage}[t]{.29\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{leftcol40}{\begin{minipage}[t]{.39\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{leftcol60}{\begin{minipage}[t]{.59\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{leftcol70}{\begin{minipage}[t]{.69\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{rightcol30}{\begin{minipage}[t]{.29\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{rightcol40}{\begin{minipage}[t]{.39\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{rightcol60}{\begin{minipage}[t]{.59\textwidth}\vspace{0pt}}{\end{minipage}}
#+LATEX_HEADER: \newenvironment{rightcol70}{\begin{minipage}[t]{.69\textwidth}\vspace{0pt}}{\end{minipage}}
...
# Note that LaTeX export uses subfigures without grid areas of CSS;
# instead, the horizontal size is derived from the number of columns,
# which in turn is computed by dividing the number of figures by the

...
![isolated_motorway](f_route/krauthausen_area.png "isolated motorway")
...
![junction tile](f_route/junction_tile.png "junction tile")
...
![network lines](f_route/network_lines.png "network lines")
_junctions into network_

local motorway structure

![route selection](f_route/route_selection.png "route selection")
...
![distances](f_route/distances.png "distances")
...
![odm](f_route/odm_9days.png "odm 9 days")
_odm on 9 days_
...
![zip2zip explanation](f_route/zip2zip_exp.png "zip2zip explanation")

we have created the enter to exit relationship matrix.

![enter to exit](f_route/enter2exit.png "enter to exit")
...
![postprocessing fix](f_route/postprocessing_fix.png "postprocessing fix")
...
![via points](f_route/via_junction.png "via point on junction")
...
![first_routing](f_route/strange_routing.png "first routing")
_inspection on routing_

After the second analyzer run:

![second_routing](f_route/improved_routing.png "second routing")
...
![size_enter_exit](f_route/size_enter_exit.png "volume of entrances and exits")
...
![pair_relations](f_route/pair_relations.png "pair relationships")
...
![junction connection](f_route/junction_connection.png "junction connection")
...
![correlation junction](f_route/correlation_junction.png "correlation between junctions")
...
![api routing](f_route/api_routing.png "openrouteservice")
...
![size_enter_exit](f_route/en2ex_image.png "removing discrepancies in enter2exit matrix")
...
![asym matrix](f_route/asym_mat.png "asymmetry matrix")
...
![weighting function](f_route/weighting_function_definition.png "weighting function definition")
...
![length_decay](f_route/length_decay.png "length decay")
...
![unprecise start](f_route/unprecise_start.png "unprecise start")
...
![routing centroid](f_route/routing_centroid.png "routing centroid")
...
![motor asymmetry](f_route/motor_asymmetry.png "motor asymmetry")
...
![start-end](f_route/en2ex_bounding.png "enter and exit bounding box")
_enter and exit bounding box_

#### DETOURS

* do we smooth the events position before routing (B-splines?)
![detour asymmetry](f_route/deroute_asymmetry.png "detours asymmetry")
...
![ab routing](f_route/ab_routing0.png "AB routing")
...
![asym history](f_route/asymmetry_history.png "asymmetry history")

The asymmetry matrix view show how the precision of the asymmetry improved from the first to the last analysis. 
![asym_improvement_sign](f_route/asym_improvement_sign.png "asymmetry improvement")
...
![junction_labeller](f_route/junction_labeller.png "junction labeller")
...
![complex_junctions](f_route/complex_junctions.png "complex junctions")
...
![thuerin matrix](f_route/thuerin_matrix.png "thuerin matrix")
_count matrices between entry and exits_

![thuerin correlation](f_route/thuerin_correlation.png "thuerin correlation")
_correlation between pair relation counts, on the rhs we magnified the zone with lower correlation_

![thuerin asym](f_route/thuerin_asym.png "thuerin asym")
_most of the relations show asymmetry but it's due to low counts_

![thuerin junSum](f_route/thuerin_junSum.png "thuerin junSum")
...
![enEx_sym](f_route/enEx_sym.png "entrance and exit symmetry")
...
![viaProJunction](f_route/viaProJunction.png "via points pro trajectory")
...
![entryExit_count](f_route/entryExit_count.png "counts of entries and exit")

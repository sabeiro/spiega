...
![example node](../f/f_prod/example_node.png "example node")
_example node_
...
![overpass json](../f/f_prod/overpass_json.png "overpass json")
...
![login dash](../f/f_prod/login_dash.png "login dash")
_login dash_

The first screen shows the counts per tile

![tile location](../f/f_prod/tile_location.png "tile location")
_tile location_
_the dashboard shows the footfalls for the selected tiles_

Data are available in hourly resolution

![hourly values](../f/f_prod/hourly_values.png "hourly values")
_hourly values_

In the front panel one can select the available dates

![date available](../f/f_prod/date_available.png "date available")
...
![footfall locations](../f/f_prod/footfall_locations.png "footfall locations")
_footfall locations_

We have a age and gender split

![age groups](../f/f_prod/age_groups.png "age groups")
_age groups_

On top of footfall we show the incoming and outcoming flow for the 4 edges of the tile:

![direction breakout](../f/f_prod/direction_breakout.png "direction breakout")
_direction breakout, north-east-south-west_

Counts are splitted in mode of transportation

![modal split](../f/f_prod/modal_split.png "modal split")
_modal split_

and we have an overview of the counts per coordinate

![tile movements](../f/f_prod/tile_movements.png "tile movements")
_tile movements_
...
![location position](../f/f_prod/location_position.png "location position")
_location position_

and the table with the reference numbers for joining tables.

![location table](../f/f_prod/location_table.png "location table")
_location table_

We can extract a report containing all the information we see in the dashboard

![footfall report](../f/f_prod/footfall_report.png "footfall report")
_footfall report_

For each tile we see where the neighboring locate

![tile directions](../f/f_prod/tile_directions.png "tile directions")
_tile directions_

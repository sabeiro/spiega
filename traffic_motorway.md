...
![bast_germany](f_via/bast_germany.png "BaSt Germany")
...
![via_tile_selection](f_via/via_tile_selection.png "via tile selection")
...
![isocal_deviation](f_via/isocal_deviation.png "isocalendar deviation")
...
![time_series](f_via/timeSeries_img.png "time series")
...
![3d](f_via/shortConv_3d.png "short conv net")
_short convNet in 3d_

We than define a slightly more complex network

![3d](f_via/convNet_3d.png "conv net")
...
![shortConv](f_via/shortConv_noBackfold.png "short convolution")
_results for the short convolution, no backfold_

If we add backfold we improve correlation and relative error

![shortConv](f_via/shortConv_week.png "short convolution")
...
![convNet](f_via/convNet_backfold.png "convNet wbackfold")
...
![boxplot_corErr](f_via/boxplot_corErr.png "boxplot")
...
![confInt](f_via/confInt_score.png "confidence interval scoring")
_confidence interval for correlation and relative error_

Ranking is not stable among the different methods

![sankey](f_via/sankey_backfold.png "sankey diagram")
...
![parallel](f_via/parallel_error.png "parallel error")
...
![cluster](f_via/cluster_1.png "1 cluster")
_most frequent cluster_

We realize the 90% of the locations and weeks have a correlation higher than 0.9

![cluster_histogram](f_via/cluster_kpiDis.png "cluster kpi distribution")
...
![cluster](f_via/cluster_2.png "2 cluster")
...
![cluster](f_via/cluster_24.png "24 cluster")
...
![cluster_histogram](f_via/cluster_histogram.png "cluster cumulative")
...
![cluster](f_via/cluster_4.png "4 cluster")
...
![cluster_polarization](f_via/cluster_polarization.png "cluster polarization")
_cluster polarization_

If we look at the weekly distribution we see that the commuting pattern ressamble our expectation

![commuting_pattern](f_via/commuting_pattern.png "commuting pattern")
...
![mimimum](f_via/local_minimum.png "local minimum")
...
![boundary_problems](f_via/boundary_problem.png "boundary problems")
...
![series_firstIndent](f_via/series_firstIndent.png "series first indent")
...
![image_interp](f_via/image_interp.png "image interpolation")
_upscaling a time series_

Running time is drammatically increased but the convergence is not better. 

![series_upscaling](f_via/series_upscaling.png "series upscaling")
...
![series_downscaling](f_via/series_downscaling.png "series upscaling")
_results of the upscaled time series_
...
![short_prediction](f_via/short_prediction.png "short prediction")
_prediction using a short autoencoder_

Some times even the short convNet look like overfitting

![short_overfitted](f_via/short_overfitted.png "short overfitted")
...
![via_algo](f_via/via_algo.png "identification of via nodes")
...
![junction](f_via/junction.png "via nodes on junction")
...
![flat_boxplot](f_via/flat_boxplot.png "flat boxplot")
_drop in performances applying the autoencoder on external data_

![short_boxplot](f_via/short_boxplot.png "short boxplot")
...
![encoder_series](f_via/encoder_series.png "encoder series")
_prediction with the encoder_

The encoder helps as well to reproduce the friday effect

![encoder_friday](f_via/encoder_friday.png "encoder friday")
_prediction has a better friday effect_

![encoder_boxplot](f_via/encoder_boxplot.png "encoder boxplot")

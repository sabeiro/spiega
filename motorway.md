...
![gas stations on the motorway](f_mot/motorway_01.png "Gas stations")
...
![location overview](f_mot/location_overview.png "overview of the different gas stations")
...
![distance distribution](f_mot/trip_distance_distribution.png "distribution of the trip distance")
_Distribution of the trip distance_

Duration as irregular distribution apart from half hour binning
![duration distribution](f_mot/duration_distribution.png "distribution of the duration")
_Distribution of duration_

We can than observe that chirality wihtin a day is conserved:
![chirality distribution](f_mot/chirality_distribution.png "distribution of chirality")
...
![input data](f_mot/input_data.png "representation of the input data")
...
![trip distance filter](f_mot/trip_filter.png "trip distance filter")
_Trip distance filter_

Trip distance filter has different effect on every single cell.
![distance filter](f_mot/distance_filter.png "filter on the trip distance")
...
![direction dinstinction](f_mot/direction_distinction.png "distinction by direction")
...
![chirality trajectory](f_mot/chirality_trajectory.png "trajectories colored by chirality")
_trajectories colored by chirality_

## Shape clustering
We want to recognize the type of user clustering different patterns:

![user patterns](f_mot/shapeCluster.svg "different patterns for kind of user")
...
![time series](f_mot/time_series.png "example of a time series")
_time series of a location_
and the daily average where we can understand the typical daily activity.

![daily average](f_mot/time_series_day.png "daily average")
...
![shape clustering](f_mot/shape_clustering.png "We cluster curves by shapes")
...
![correlation matrix](f_mot/correlation_matrix.png "correlation matrix between features")
...
![selected features](f_mot/selected_features.png "final selection of features")
...
![scoring explanation](f_mot/scoring.png "scoring graphical visualization")
...
![score binning](f_mot/bin_correlation.png "binning the correlation score")
...
![model score](f_mot/model_score.png "result and score of the models")
...
![box plot post prediction](f_mot/boxplot_post.png "box plot post prediction assignment")
...
![correlation distribution after filtering](f_mot/correlation_distribution.png "correlation distribution after filtering")
...
![matrix correlation](f_mot/matrix_correlation.png "reference and predicted matrix correlation")
...
![kpi zone](f_mot/kpi_id_zone_all.png "cumulative distribution of correlation and difference")
...
![kpi cor](f_mot/kpi_id_zone_cor.png "we select only the cells whose correlation is above 0.30")
...
![kpi zone](f_mot/kpi_id_clust_all.png "cumulative distribution of correlation and difference")
_cumulative distribution of correlation and difference_

We can still improve the correlation by apply a score selection
![kpi zone](f_mot/kpi_id_clust_cor.png "cumulative distribution of correlation and difference")
...
![geographic information enrichment](f_mot/data_enrichment.png "Geographic information enrichment for troubleshooting")
...
![regression tree](f_mot/regression_tree.png "regression tree location dependent")
...
![difference dependence](f_mot/difference_dependance.png "dependance of the mismatch on the variables")
...
![counts corrected](f_mot/kpi_correction.png "counts mismatch after correction")
...
![chirality distribution](f_mot/chirality_distribution.png "activity and reference")
_activity vs reference_

## Results generation
Applying both predictor and regressor and we generate:
![result no order](f_mot/result_no_order.png "resulting activities per location")
...
![result order](f_mot/result_order.png "activities sorted by p-value")
_activities sorted by p-value_

To summarize we generate the results applying the following scheme:
![filter structure](f_mot/filter_structure.png "application of the predictor and regressor")
...
![flow chart](f_mot/test_flow.png "flow chart of the project")
_flow chart of the project_

## Result visualization
We display overall correlation on a map
![correlation map](f_mot/correlation_map.png "correlation map")
_correlation map_

Isolated spots show good correlation
![good correlation](f_mot/correlation_good.png "good correlation")
_example of good correlation_

Spots close to cities show bad correlation
![bad correlation](f_mot/correlation_bad.png "good correlation")
_example of bad correlation_


Correlation increases when take more locations together
![correlation map spot](f_mot/correlation_map_spot.png "correlation map spot")
_correlation map on a spot_

We can calculate the counts even without reference data
![map counts](f_mot/map_counts.png "counts on a map")
...
![capture rate](f_mot/capture_rate1.png "capture rate of gas station")
...
![capture rate](f_mot/capture_rate2.png "capture rate of gas station")
_capture rate, high predictions_

We might even see more symmetry than customer
![capture rate](f_mot/capture_rate3.png "capture rate of gas station")
...
* market share
* [motorway network](smb://172.25.219.204:/home/gmarelli/lav/motion/gis/geo/motorway.shp)
* [BAst traffic counts](http://www.bast.de/DE/Verkehrstechnik/Fachthemen/v2-verkehrszaehlung/Aktuell/zaehl_aktuell_node.html)
* [Destatis population density](smb://172.25.219.204:/home/gmarelli/lav/motion/gis/geo/pop_dens.shp)

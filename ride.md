...
We have a look at the status table

|key | value|
| - | - |
iotid               |                       43:CD:D4:12:81:E0|
latitude            |                                 53.5559|
longitude           |                                  9.9817|
gnssupdatedat       |                     2019-09-09 14:02:30|
vehicleenergylevel  |                                      29|
mileage             |                                       0|
connected           |                                    True|
locked              |                                    True|
name                |                                  542407|
description         |                                  542407|
vehicleserialnumber |                         861319030291431|
previousstate       |                                    IDLE|
state               |                         INTENT_RESERVED|
userid              |    34208349-0b99-4061-9fd8-56f12b1072cd|
zoneid              |                                 hamburg|
usertype            |                              BACKOFFICE|

We group this information organizing the time variant information into a matrix called `tx` and summarize the dynamic quantities in their appropriate column 
...
![user_ride](f_ride/user_state.png "user ride")
...
![ride_map](f_mov/ride_map.png "ride_map")
_rides on map_

![ride_monitoring](f_mov/ride_monitoring.png "ride_monitoring")
_rides monitoring_

We can sum up rides per geohash

![ride_geohash](f_mov/ride_geohash.png "ride geohash")
_rides on geohash_

And calculate the origin/destination matrix

![odm_matrix](f_mov/odm_matrix.png "origin destination matrix")
_origin destination matrix_

We can than calculate a simplified graph of the customer movements

![graph_customer](f_mov/graph_customer.png "graph_customer")
_customer movements on graph_

# hapi

Hapi (hardware api) is the table that contains all the communication with the hardware. 
...
|type              |                                Vehicle|
|-|-|
|chainid            |   1b602d80-e03c-464a-b1fd-3e19d0a3319b|
|version            |                                      1|
|iotid              |                      F9:42:92:5B:C4:D0|
|latitude           |                                41.8594|
|longitude          |                                 12.537|
|stateupdatedat     |                    2019-08-01 00:00:00|
|vehicleenergylevel |                                     98|
|mileage            |                                      0|
|connected          |                                   True|
|locked             |                                  False|
|charging           |                                  False|
...
![rev_revboxplot][f_ride/rev_boxplot.png "revenue boxplot"]
_revenue boxplot_

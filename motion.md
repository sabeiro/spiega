...
![dens_germany](f_mov/dens_germany.png "dens germany")
...
![dens_city](f_mov/dens_city.png "dens_city")
_densities in the city_

<!-- ![dens_germany](f_mov/dens_germany.png "dens_germany") -->
<!-- _density overall the country_ -->

We can clearly distinguish users driving on main roads

![dens_street](f_mov/dens_street.png "dens_street")
...
![trajectory_country](f_mov/trajectory_country.png "trajectory_country")
_trajectory country_

All trajectories are defined by a bounding box which makes spatial filtering efficient

![dens_traj](f_mov/dens_traj3.png "dens traj")
...
![user_frequency](f_mov/user_frequency.png "user frequency")
_user frequency_

If we look at the distribution of events per users we notice extreme numbers and the median drops to 19

![user_distribution](f_mov/user_distribution.png "user distribution")
_user distribution_
...
![speed_calculation](f_mov/speed_calculation.png "speed_calculation")
_speed calculation_
...
![speed_density](f_mov/speed_density.png "speed density")
_speed density_

We can also observe the distribution of chirality across the city

![chirality_density](f_mov/chirality_distribution.png "chirality density")
_chirality density_

and the distribution of angles, interesting there are some spots strongly polarized

![angle_density](f_mov/angle_distribution.png "angle density")
_angle density_
...
![odm_dwelling](f_mov/odm_dwelling.png "dwelling odm")
...
![motion_detail](f_mov/motion_detail.png "motion detail")
...
![dwelling_heatmap](f_mov/dwelling_heatmap.png "dwelling heatmap")
_dwelling heatmap_
...
![retail_density](f_mov/retail_density.png "retail density")
_retail areas and densities_

Compared to mobile data we have a completely different ranking of locations

![retail_ranking](f_mov/retail_ranking.png "retail ranking")

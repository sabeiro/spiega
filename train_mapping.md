...
![capture_rate](f_mot/capture_rate.svg "capture rate")
...
![noise_stability](f_mot/noise_stability.png "noise stability")
...
![noise_reference](f_mot/noise_stability_hour.png "noise reference")
_noise on reference data_

We see the effect of noise on reference data

![noise_reference](f_mot/noise_reference.png "noise reference")
_noise on reference data_
...
![isocalendar deviation](f_mot/isocalendar_deviation.png "isocalendar deviation")
...
![forecastable_good](f_mot/forecastable_good.png "forecastable good")
_example of good forecastable model_

While some are not understood from the neural network

![forecastable_bad](f_mot/forecastable_bad.png "forecastable bad")
...
![act_filter](f_mot/act_filter.svg "filter on activities")
...
![filter_line](f_mot/filter_line.png "effect of filters on curves")
_effect of filters on curves_

![filter_boxplot](f_mot/filter_boxplot.png "effect of filters on curves")
...
![cilac_correlation](f_mot/cilac_correlation2.png "correlation between cilac")
...
![mapping_raw](f_mot/mapping_raw.png "raw data")
...
<!-- ![mapping_leastSq](f_mot/mapping_leastSq.png "mapping optimizing counts") -->
<!-- _activities after reweighting_ -->

<!-- or optimize correlation -->
<!-- ![mapping_corOpt](f_mot/mapping_corOpt.png "mapping optimizing correlation") -->
...
<!-- ![mapping_reweighted](f_mot/mapping_reweighted.png "reweighted mapping") -->
<!-- _reweighted mapping from cilac level_ -->

![mapping linear regression](f_mot/mapping_linearReg.png "linear regression")
...
![filter_correlation](f_mot/filter_correlation.png "filter correlation")
...
![chirality_evolution](f_mot/chirality_evolution.png "chirality evolution")
...
![correlation steps](f_mot/correlation_step.png "correlation step")
...
![dir_count](f_mot/dir_count.png "direction count")
_direction counts_
...
![capRate_evolution](f_mot/captRate_evolution.png "capture rate evolution")
...
![capRate_boxplot](f_mot/captRate_boxplot.png "capture rate boxplot")
...
![kpi_boost](f_mot/kpi_boost.png "kpi of boosting")
_kpi boost_
...
![longShort_prep](f_mot/longShort_prep.png "preparation")
_input data_
...
![longShort_hist](f_mot/longShort_hist.png "performance history")
...
![score_range](f_mot/score_range.png "range of scores")

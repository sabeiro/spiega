...
![daily_visit](f_mot/daily_visit.png "distribution of daily visits")
...
![raw data](f_mot/ref_series.png "reference time series")
...
![ref_smoothing](f_mot/prep_poly_smooth.png "smoothing of reference data")
...
![ref_volatility](f_mot/chisq_dis.png "chi square of the reference time series")
_Distribution of p-value from $\chi^2$ for the reference data_

We than replace the outliers:

![replace_volatility](f_mot/replace_volatile.png "we replace volatile days with an average day")
...
![week_image](f_mot/week_img.png "image representation of many weeks")
...
![tensorboard](f_mot/tensorboard.png "sketch of the learning phases")
...
![raw_vs_predicted](f_mot/ref_pred.png "results of predictor")
...
![autoencoder_performance](f_mot/autoencoder_performance.png "autoencoder performance")
...
![holiday_effect](f_mot/thursday_series.png "proximity to easter")
_Visits versus activities in Mach approaching easter_

The same effect was seen in March 2017 in the test data.
![test_days](f_mot/correlation_map.png "visits increased closed to easter")
...
![location_overview](f_mot/location_overview.png "composite gas stations")
...
![act_vist](f_mot/act_vist_cor.png "activities vs visits with low correlation")
...
![weekday_deviation](f_mot/weekday_deviation.png "weekday deviations")
...
![deviation_temperature](f_mot/deviation_temperature.png "deviation temperature")
_deviation vs minimum temperature, binned_

We select the most relevant weather features over a selection of 40.
![weather feature](f_mot/weather_feature.png "weather features")
_correlation between weather features_

Other weather related parameters have an influence on the mismatch.
![weather_correlation](f_mot/weather_correlation.png "weather influences the difference")
...
![bast raw](f_mot/bast_weeks.png "bast raw data")
...
![bast autoencoder](f_mot/bast_autoencoder.png "bast autoencoder")
...
![correction_dirCount](f_mot/corr_dirCount.png "correction of direction counts")
...
![bad_correlation](f_mot/correlation_bad_city.png "bad correlation in dense area")
...
![data_enrichment](f_mot/data_enrichment.png "density population data")
_we enrich our data with information about population density_

## Skew XII - directions
Sometimes direction distiction does not perform well
![correlation_direction](f_mot/correlation_1bad_1good.png "direction distinction not performing")
...
![curve_overlapping](f_mot/curve_overlapping.png "cilacs and reference data")
...
![counts_filter](f_mot/filter_asymmetric.png "counts depending on distance filter")
...
![dif_abs](f_mot/dif_abs.png "low visits, lower precision")
...
![track_stop](f_mot/track_stop.png "preferred track stop")
...
![people_car](f_mot/people_car.png "profile of people per car")
...
![stat prop](f_mot/stat_prop.png "statistical properties")
...
![importance statistical properties](f_mot/importance_statProp.png "importance of statistic properties")
...
![stat prop traininig](f_mot/statProp_training.png "training on statistical properties")
...
![feature importance](f_mot/feature_importance.png "feature importance")
...
![confusion matrix](f_mot/confusion_feature.png "confusion matrix on input feature")
...
![model_score](f_mot/model_score.png "performance of models")
...
![google_popularity](f_mot/google_popularity.png "popularity from google")
...
![vis_act_pop](f_mot/vis_act_pop_curve.png "visits, activities, popularity")
...
![vis_act_pop_dis](f_mot/vis_act_pop_dis.png "accuracy between sources")
...
![tank_mc](f_mot/tank_mc.png "service station and restaurant")
...
Service station and restaurant share the same location
![restaurant_service](f_mot/restaurant_service.png "service station and restaurants")
...
![restaurant_service](f_mot/restaurant_service_day.png "service station and restaurants")

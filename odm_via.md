...
![hourly weekday](f_odm/hourly_weekday.png "hourly weekday")
_hourly weekday_
...
![ref_geom](f_odm/ref_geom.png "reference geometry")
...
![pvt vs_odmVia](f_odm/ptv_vs_odmVia.png "pvt vs_odmVia")
...
![node_location](f_odm/node_location.png "node location")
_selected nodes_

Usege of via nodes on a origin and destination matrix

![od_via](f_mod/od_via.ong "od via")

---
title: "Tank und Rast delivery pipeline"
...
This readme explains the content of the directory and the execution steps to complete the delivery for Tank & Rast.

![curves](f_mot/curves.png "delivery_curves")
_delivery curves_
...
![proj_dir](f_mot/proj_dir.png "project directory")
_project directory_
...
![jupyter](f_mot/jupyter.png "jupyter")
...
![mapping](f_mot/mapping.png "example of mapping result")
...
![regression](f_mot/regression.png "results after regression")
_results after regression_
  
## KPI

![joyplot](f_mot/joyplot.png "joyplot")
...
![sankey](f_mot/sankey.png "sankey")
_t-test feb-mar vs t-test mar-apr, change in ranking_
  
## internal meeting

![boxplot](f_mot/boxplot.png "boxplot")
...
![isocalendar](f_mot/isocalendar.png "isocalendar")
...
![delivery](f_mot/delivery.png "delivery")
